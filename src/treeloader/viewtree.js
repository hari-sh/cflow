...
class Markmap {
    ...
    setDataHash(hashdata, diagStr, ishashmap) {
        if(diagStr)
        {
            this.state.data = {
                content: diagStr,
    ...
    setDatanHash(hashdata, ishashmap) {
    ...
    static create(svg, hashdata, data = null, ishashmap) {
        ...
        {
            mm.setDatanHash(hashdata, ishashmap);
        }
        mm.fit();
        return mm;
    }
...
export { viewtree as __moduleExports };
export { Markmap_1 as Markmap };