...
{   
printf("Detector::Configure : entry");
    // Set variables
...
printf("Detector::Configure : exit");
    return 0;
printf("Detector::Configure : endoffun");
}
...
{
printf("Detector::ExecuteCorrelator : entry");
    ...
    // Return result
printf("Detector::ExecuteCorrelator : exit");
    return correlation;
printf("Detector::ExecuteCorrelator : endoffun");
}
...
{   
printf("Detector::FindSymbolStart : entry");
    ...
    // Return Symbol start
printf("Detector::FindSymbolStart : exit");
    return symbolStart;
printf("Detector::FindSymbolStart : endoffun");
}
...
{
printf("Detector::FineSearch : entry");
    double min = 100000;
...
printf("Detector::FineSearch : exit");
    return lowestImgIndex;
printf("Detector::FineSearch : endoffun");
}
...
{
printf("Detector::CoarseSearch : entry");
...
printf("Detector::CoarseSearch : exit");
...
printf("Detector::CoarseSearch : exit");
    return 0;
printf("Detector::CoarseSearch : endoffun");
}
...
int Detector::Close()
{   
printf("Detector::Close : entry");
    m_nPrefix = 0;
    m_symbolSize = 0;
    m_configured = 0;
printf("Detector::Close : exit");
    return 0;
printf("Detector::Close : endoffun");
}
